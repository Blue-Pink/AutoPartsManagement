...
namespace APM.ConTaxi.Migrations
{
    ...
    [Migration("20260511082150_Migration_9_AddEntityModifyRecord")]
    partial class Migration_9_AddEntityModifyRecord
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APM.DbEntities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("APM.DbEntities.EntityModifyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("APM.DbEntities.Views.AllBoundItemView", b =>
                {
                    b.Property<DateTime?>("CreatedAt")
                        .HasColumnType("datetime2");
                    ...
                    b.ToView("vw_AllBoundItemView", (string)null);
                });
            ...
            modelBuilder.Entity("APM.DbEntities.EntityModifyRecord", b =>
                {
                    ...
                    b.HasOne("APM.DbEntities.User", "ModifiedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("APM.DbEntities.InboundItem", b =>
                {
                    b.HasOne("APM.DbEntities.InboundOrder", "InboundOrder")
            ...
            modelBuilder.Entity("APM.DbEntities.OutboundItem", b =>
                {
                    ...
                    b.HasOne("APM.DbEntities.OutboundOrder", "OutboundOrder")
            ...
            modelBuilder.Entity("APM.DbEntities.OutboundOrder", b =>
                {
                    b.HasOne("APM.DbEntities.Customer", "Customer")
                        .WithMany()
