...
namespace APM.ConTaxi.Migrations
{
    ...
    [Migration("20260420090613_Migration_3_CreatePartView")]
    partial class Migration_3_CreatePartView
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("APM.DbEntities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("APM.DbEntities.Unit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("APM.DbEntities.Part", b =>
                {
                    b.HasOne("APM.DbEntities.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("APM.DbEntities.Unit", "Unit")
                        .WithMany()
